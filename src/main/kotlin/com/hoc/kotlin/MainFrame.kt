...
class MainFrame : JFrame(), Contract.View {
  ...
  private val actor = CoroutineScope(Dispatchers.Main).actor<MouseEvent>(capacity = Channel.CONFLATED) {
    for (evt in this) {
  ...
  private fun initComponents() {
    ...
    myPanel1Layout.setHorizontalGroup(
        myPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 340, Short.MAX_VALUE.toInt())
    )
    myPanel1Layout.setVerticalGroup(
        myPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGap(0, 583, Short.MAX_VALUE.toInt())
    )
